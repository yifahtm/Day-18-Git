...
function onBallClick(maxDiameter, operator) {
    ...
    gBall2Size = operator === '+' ? gBall2Size + gBall2SizeStep : gBall2Size - gBall2SizeStep
...
function onBall2Click(maxDiameter, operator) {
